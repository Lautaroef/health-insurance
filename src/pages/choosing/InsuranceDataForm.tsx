...
const ElementPlan = ({ active, children }: ElementPlanValues) => {
  return (
    <li>
      <Heart size={12} className={active ? "color-primary" : "color-gray-medium"} />
...
export default function InsuranceDataForm({ person }: InsuranceFormValues) {
  ...
  return (
    ...
    >
      {(formik) => {
        const addRelative = (relationship: string, relativeBirthDate: string) => {
            ...
            {step === 2 ? (
              <>
                  ...
                  {PLANS.map((plan) => {
                    return (
                      ...
                      >
                        ...
                        {plan.name === formik.values.plan ? (
                          <img className="check-icon" src={urlIconCorrect} alt="check" />
                        ) : null}
                      </label>
                    );
                  })}
                ...
                <div className="flex justify-end choosing-submit-section">
                  <button type="button" className="btn-white font-11 border-bottom-gray-light">
                    ENVIAR COTIZACIÓN POR CORREO
                  </button>
                  <button type="submit" className="btn font-11" onClick={goThanksPage}>
                    COMPRAR PLAN
                  </button>
                </div>
              </>
